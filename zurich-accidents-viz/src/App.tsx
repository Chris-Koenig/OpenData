  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        if (data.length === 0) {
          console.error(
            "No data points were processed successfully, using fallback test data"
          );
          ...
          const fallbackData: CoordinatePoint[] = [
            {
              ...
              lng: 8.5417,
              accident: {
                AccidentUID: "fallback1",
                AccidentType: "Test",
                AccidentType_en: "Fallback Pedestrian Accident",
                AccidentSeverityCategory: "test",
                AccidentSeverityCategory_en: "Test Severity",
                AccidentInvolvingPedestrian: "true",
                AccidentInvolvingBicycle: "false",
                AccidentInvolvingMotorcycle: "false",
                RoadType_en: "Test Road",
                AccidentLocation_CHLV95_E: "2683000",
                AccidentLocation_CHLV95_N: "1247000",
                AccidentYear: "2023",
                AccidentMonth: "7",
            ...
            },
            {
              ...
              lng: 8.55,
              accident: {
                AccidentUID: "fallback2",
                AccidentType: "Test",
                AccidentType_en: "Fallback Bicycle Accident",
                AccidentSeverityCategory: "test",
                AccidentSeverityCategory_en: "Test Severity",
                ...
                AccidentInvolvingMotorcycle: "false",
                RoadType_en: "Test Road",
                AccidentLocation_CHLV95_E: "2684000",
        ...
        const errorMessage =
          err instanceof Error ? err.message : "Failed to load accident data";
        ...
        const fallbackData: CoordinatePoint[] = [
          {
            ...
            lng: 8.5417,
            accident: {
              AccidentUID: "error-fallback1",
              AccidentType: "Test",
              AccidentType_en: "Error Fallback Pedestrian",
              AccidentSeverityCategory: "test",
              AccidentSeverityCategory_en: "Test Severity",
              AccidentInvolvingPedestrian: "true",
              AccidentInvolvingBicycle: "false",
          ...
          },
          {
            ...
            lng: 8.55,
            accident: {
              AccidentUID: "error-fallback2",
              AccidentType: "Test",
              AccidentType_en: "Error Fallback Bicycle",
              AccidentSeverityCategory: "test",
              AccidentSeverityCategory_en: "Test Severity",
              AccidentInvolvingPedestrian: "false",
              AccidentInvolvingBicycle: "true",
