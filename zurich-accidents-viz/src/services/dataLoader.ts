          ...
          try {
            ...
            for (let index = 0; index < maxRows; index++) {
              ...
              if (!eastField || !northField) {
                ...
                if (index < 5)
                  console.log(
                    `Row ${index}: Missing coordinates - E:${eastField}, N:${northField}`
                  );
                continue;
              }
              ...
              if (east === 0 || north === 0) {
                ...
                if (index < 5)
                  console.log(
                    `Row ${index}: Invalid coordinates - E:${east}, N:${north}`
                  );
                continue;
              }
              ...
              if (index < 3) {
                console.log(
                  `Row ${index}: LV95(${east}, ${north}) -> WGS84(${lat}, ${lng})`
                );
              }
              ...
              if (
                ...
                if (index < 5)
                  console.log(
                    `Row ${index}: Out of bounds - lat:${lat}, lng:${lng}`
                  );
                continue;
              }
              ...
              const accident: AccidentData = {
                ...
                AccidentInvolvingBicycle:
                  row.AccidentInvolvingBicycle || "false",
