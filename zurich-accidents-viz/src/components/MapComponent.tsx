          ...
          >
            <Popup>
              <div className="accident-popup">
                ...
                <p><strong>Severity:</strong> {point.accident.AccidentSeverityCategory_en}</p>
                <p><strong>Year:</strong> {point.accident.AccidentYear}</p>
                <p><strong>Month:</strong> {point.accident.AccidentMonth_en}</p>
                <p><strong>Day:</strong> {point.accident.AccidentWeekDay_en}</p>
                <p><strong>Hour:</strong> {point.accident.AccidentHour}</p>
                <p><strong>Road Type:</strong> {point.accident.RoadType_en}</p>
                {point.accident.AccidentInvolvingPedestrian === 'true' && (
                  <span className="involvement-badge pedestrian">Pedestrian</span>
                )}
                ...
                {point.accident.AccidentInvolvingMotorcycle === 'true' && (
                  <span className="involvement-badge motorcycle">Motorcycle</span>
                )}
              </div>
            </Popup>
          </Marker>
